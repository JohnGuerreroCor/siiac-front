...
import { NormogramaExcelService } from 'src/app/services/normograma-excel.service';
  ...
  exportToExcel() {
    ...
    this.normaService.obtenerListadoNormas().subscribe((data) => {
      ...
      if (JSON.stringify(data) !== '[]') {
        ...
        let reportData = {
          title: 'Normograma Facultad de Ciencias de la Salud Proceso de Calidad ' + fecha,
